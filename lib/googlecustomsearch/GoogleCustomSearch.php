<?php
namespace SmFunctions\googlecustomsearch;
/**
        ...
        if (isset($response->items)) {
            ...
            foreach ($response->items as $result) {
                ...
                $results->results[] = (object) [
                    ...
                    'metatags' => isset($result->pagemap->metatags) ? $result->pagemap->metatags[0] : '',
                    'newsarticle' => isset($result->pagemap->newsarticle) ? $result->pagemap->newsarticle[0] : '',
                ];
            }   
        }
